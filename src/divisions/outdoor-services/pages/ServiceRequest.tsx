...
import { submitServiceRequest } from "../../../services/api/outdoorServices";
...
function ServiceRequest() {
  ...
  if (submitted) {
    return (
      <section className="outdoor-services-form-page">
        <div className="container outdoor-services-form-success">
          <p className="outdoor-services-eyebrow">Request Received</p>
          ...
          <div className="outdoor-services-form-success__actions">
            <button
            ...
            <Link className="outdoor-services-button outdoor-services-button--secondary" to={ROUTES.divisions.outdoorServices.root}>
              Return Home
            </Link>
          </div>
        </div>
  ...
  if (reviewing) {
    return (
      <section className="outdoor-services-form-page">
        <div className="container outdoor-services-review-card">
          <p className="outdoor-services-eyebrow">Review Request</p>
          <h1>Confirm the service details.</h1>
          <dl className="outdoor-services-review-list">
          ...
          <div className="outdoor-services-form-actions">
            <button className="outdoor-services-button outdoor-services-button--secondary" type="button" onClick={() => setReviewing(false)}>
              Back to Edit
            </button>
            <button className="outdoor-services-button outdoor-services-button--primary" type="button" onClick={handleSubmit} disabled={isSubmitting}>
  ...
  return (
    <section className="outdoor-services-form-page">
      <div className="container outdoor-services-form-page__layout">
        <div className="outdoor-services-form-page__intro">
          <p className="outdoor-services-eyebrow">Service Request</p>
          ...
          <Link to={ROUTES.divisions.outdoorServices.quote}>Need an estimate instead? Request a quote →</Link>
        </div>

        <form className="outdoor-services-customer-form" onSubmit={handleReview}>
          <fieldset>
          ...
          <fieldset>
            ...
            <div className="outdoor-services-form-grid">
              <label className="outdoor-services-form-grid__wide"><span>Street Address *</span><input required value={data.address} onChange={(event) => update("address", event.target.value)} /></label>
          ...
          <fieldset>
            ...
            <div className="outdoor-services-form-grid">
              ...
              <label className="outdoor-services-form-grid__wide"><span>Describe the work requested *</span><textarea required rows={6} value={data.details} onChange={(event) => update("details", event.target.value)} /></label>
              <label className="outdoor-services-form-grid__wide"><span>Gate code, pets, access instructions, or other notes</span><textarea rows={3} value={data.accessNotes} onChange={(event) => update("accessNotes", event.target.value)} /></label>
            </div>
          </fieldset>
          ...
          <div className="outdoor-services-form-actions">
            <button className="outdoor-services-button outdoor-services-button--secondary" type="button" onClick={() => setData(initialData)}>Clear</button>
            <button className="outdoor-services-button outdoor-services-button--primary" type="submit">Review Request</button>
          </div>
        </form>
      </div>
    </section>
